type BadgeStatus = 'approved' | 'pending' | 'rejected' | 'submitted' | 'not-submitted' | 'evaluated';
...
const config: Record<BadgeStatus, { label: string; className: string }> = {
  ...
  evaluated:       { label: '평가완료', className: 'bg-indigo-100 text-indigo-700 ring-indigo-200' },
};
